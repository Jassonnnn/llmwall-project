...
6. 手动启动前端联调：看 `MANUAL_START_SAFETYDASH.md`
...
| `MANUAL_START_SAFETYDASH.md` | 从终端手动启动 `jb_demo + dashboard-api + safetydash` 的操作手册 | 本地联调/演示 |
| `REPORT_PROGRESS_2026-03-25.md` | 阶段成果、提交时间线、汇报口径 | 组会/周报汇报 |
| `WEEKLY_REPORT_SCRIPT.md` | 按周拆分的口头汇报话术（第 2 周 - 第 13 周） | 组会口头汇报 |
